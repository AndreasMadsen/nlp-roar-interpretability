...
if __name__ == '__main__':
    ...
    if args.k == 0:
        ...
        base_experiment_id = generate_experiment_id('imdb', args.seed, args.k-1 if args.recursive else 0, args.importance_measure, args.recursive)
    ...
    with open(f'{args.persistent_dir}/results/{experiment_id}.json', "w") as f:
        json.dump({"seed": args.seed, "dataset": f"imdb",
